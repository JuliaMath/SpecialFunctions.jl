@testset "gamma and friends" begin
    ...
    @testset "BigFloat" begin
        # test cases (values taken from WolframAlpha)
        @test loggamma(big(3.099)) ≈ 0.786413746900558058720665860178923603134125854451168869796
        @test loggamma(big(1.15)) ≈ -0.06930620867104688224241731415650307100375642207340564554
        @test logabsgamma(big(0.89))[1] ≈ 0.074022173958081423702265889979810658434235008344573396963
        @test loggamma(big(0.91)) ≈ 0.058922567623832379298241751183907077883592982094770449167
        @test loggamma(big(0.01)) ≈ 4.599479878042021722513945411008748087261001413385289652419
        @test loggamma(1 + exp2(big(-20.0))) ≈ -5.504750066148866790922434423491111098144565651836914e-7

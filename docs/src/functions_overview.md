...
| [`wrightbessel(a,b,x)`](@ref SpecialFunctions.wrightbessel)        | [Wright's generalized Bessel function](https://en.wikipedia.org/wiki/Bessel%E2%80%93Maitland_function)                                                                 |

...
| [`gamma(a,z)`](@ref SpecialFunctions.gamma(::Number,::Number))  | [upper incomplete gamma function ratio ``\Gamma(a,z)``](https://en.wikipedia.org/wiki/Incomplete_gamma_function) |

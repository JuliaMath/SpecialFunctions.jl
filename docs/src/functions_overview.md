...
| [`invtrigamma(x)`](@ref SpecialFunctions.invdigamma)                  | [invdigamma function](https://rdrr.io/bioc/limma/src/R/fitFDist.R) (i.e. inverse of `trigamma` function at `x` using fixed-point iteration algorithm)                           |
| [`tetragamma(x)`](@ref SpecialFunctions.tetragamma)                      | [tetragamma function](https://mathworld.wolfram.com/PolygammaFunction.html) (i.e the logarithmic third derivative of `gamma` at `x`)                                                                       |
...
[Exponential and Trigonometric Integrals - DLMF](https://dlmf.nist.gov/6)
...
| [`airyaix(z)`](@ref SpecialFunctions.airyaix), [`airyaiprimex(z)`](@ref SpecialFunctions.airyaiprimex), [`airybix(z)`](@ref SpecialFunctions.airybix), [`airybiprimex(z)`](@ref SpecialFunctions.airybiprimex) | scaled Airy Ai function and derivative at `z` |

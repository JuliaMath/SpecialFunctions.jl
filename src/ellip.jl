...
@inline function _ellipk_horner_table(idx::Int, m::Float64)
    ...
    elseif idx == 1  # 0.1 <= m < 0.2, Table 3
        t = m - 0.15
        return @horner(t,
    ...
    elseif idx == 2  # 0.2 <= m < 0.3, Table 4
        t = m - 0.25
        return @horner(t,
    ...
    elseif idx == 3  # 0.3 <= m < 0.4, Table 5
        t = m - 0.35
        return @horner(t,
    ...
    elseif idx == 4  # 0.4 <= m < 0.5, Table 6
        t = m - 0.45
        return @horner(t,
    ...
    elseif idx == 5  # 0.5 <= m < 0.6, Table 7
        t = m - 0.55
        return @horner(t,
    ...
    elseif idx == 6  # 0.6 <= m < 0.7, Table 8
        t = m - 0.65
        return @horner(t,
    ...
    elseif idx == 7  # 0.7 <= m < 0.8, Table 9
        t = m - 0.75
        return @horner(t,
    ...
    elseif idx == 8  # 0.8 <= m < 0.9
        if m < 0.85  # Table 10, 0.8 <= m < 0.85
            t = m - 0.825
            return @horner(t,

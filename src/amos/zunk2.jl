 _ZUNK2_ZETA2R = Array{Float64}(2)
 _ZUNK2_ZETA2I = Array{Float64}(2)
 _ZUNK2_ZETA1R = Array{Float64}(2)
 _ZUNK2_ZETA1I = Array{Float64}(2)
 _ZUNK2_PHIR = Array{Float64}(2)
 _ZUNK2_PHII = Array{Float64}(2)
 _ZUNK2_CYR = Array{Float64}(2)
 _ZUNK2_CYI = Array{Float64}(2)
 _ZUNK2_CSSR = Array{Float64}(3)
 _ZUNK2_CSRR = Array{Float64}(3)
 _ZUNK2_CIPR = Array{Float64}(4)
 _ZUNK2_CIPI = Array{Float64}(4)
 _ZUNK2_BSUMR = Array{Float64}(2)
 _ZUNK2_BSUMI = Array{Float64}(2)
 _ZUNK2_BRY = Array{Float64}(3)
 _ZUNK2_ASUMR = Array{Float64}(2)
 _ZUNK2_ASUMI = Array{Float64}(2)
 _ZUNK2_ARGR = Array{Float64}(2)
 _ZUNK2_ARGI = Array{Float64}(2)
function ZUNK2(ZR::Float64,ZI::Float64,FNU::Float64,KODE::Int32,MR::Int32,N::Int32,YR::AbstractArray{Float64},YI::AbstractArray{Float64},NZ::Int32,TOL::Float64,ELIM::Float64,ALIM::Float64)
    ...
    ZET2DR::Float64 = zero(Float64)
     ZETA1I = _ZUNK2_ZETA1I
     ZETA1R = _ZUNK2_ZETA1R
     ZETA2I = _ZUNK2_ZETA2I
     ZETA2R = _ZUNK2_ZETA2R

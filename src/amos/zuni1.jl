 _ZUNI1_CYR = Array{Float64}(2)
 _ZUNI1_CYI = Array{Float64}(2)
 _ZUNI1_CWRKR = Array{Float64}(16)
 _ZUNI1_CWRKI = Array{Float64}(16)
 _ZUNI1_CSSR = Array{Float64}(3)
 _ZUNI1_CSRR = Array{Float64}(3)
 _ZUNI1_BRY = Array{Float64}(3)
